...
const Board = ({ match }) => {
  ...
  useEffect(() => {
    if (board?.title) document.title = board.title + ' | PJM';
  }, [board?.title]);
    ...
    <div
      ...
      style={{
        backgroundImage:
          ...
          (board.backgroundURL
            ? board.backgroundURL
            : 'https://images.unsplash.com/photo-1620207418302-439b387441b0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1267&q=80') +
          ')',
      }}
    >
      <Navbar />
